...
describe('MenuLink', () => {
    ...
    it('should render menu link for cashier for real account on traders hub', async () => {
    ...
    it('should render menu link for cashier for virtual account on traders hub', async () => {
