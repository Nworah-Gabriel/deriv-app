...
describe('<DepositNowOrLaterModal />', () => {
    ...
    it('should call setShouldShowDepositNowOrLaterModal with false when try to click confirm button', async () => {
        render(<DepositNowOrLaterModal />, {
            wrapper: wrapper(),
        });
    ...
    it('should call setShouldShowDepositNowOrLaterModal and setShouldShowOneTimeDepositModal for ROW account when try to click cancel or close button', async () => {
        render(<DepositNowOrLaterModal />, {
            wrapper: wrapper(),
        });
