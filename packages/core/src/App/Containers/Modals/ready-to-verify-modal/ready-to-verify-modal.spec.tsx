...
describe('<ReadyToVerifyModal />', () => {
    ...
    it('should render the component with deposit success message if client deposited for the first time', async () => {
        ...
        await userEvent.click(maybe_later_button);
    ...
    it('should render the component with account created messages if client skip first_time deposit', async () => {
        const mock = mockStore({
            ui: {
                should_show_account_success_modal: true,
            },
