...
describe('ToggleCardDialog', () => {
    ...
    it('should render ContractUpdateForm when edit icon is clicked', async () => {
    ...
    it('should not render ContractUpdateForm when edit icon is clicked if is_risk_management_edition_disabled === true', async () => {
    ...
    it('should call addToast with specific text content if should_show_warning && is_risk_management_edition_disabled === true and it is mobile device', async () => {
    ...
    it('should call addToast with specific text content if should_show_warning && is_risk_management_edition_disabled && is_accumulator === true and it is mobile device', async () => {
        render(
