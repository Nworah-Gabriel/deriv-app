...
describe('Tour Start Dialog', () => {
    ...
    it('render TourStartDialog component with active tour as bot builder and dialog closed when clicking start', async () => {
        mock_store.ui.is_desktop = true;
        mock_DBot_store.dashboard.setTourDialogVisibility(true);
        mock_DBot_store.dashboard.setActiveTab(DBOT_TABS.BOT_BUILDER);
        ...
        await userEvent.click(start_button);
    ...
    it('render TourStartDialog component with show_mobile_tour_dialog as false when clicking start in mobile', async () => {
    ...
    it('render TourStartDialog component with dialog closed when clicking skip', async () => {
        mock_store.ui.is_desktop = true;
        mock_DBot_store.dashboard.setTourDialogVisibility(true);
        mock_DBot_store.dashboard.setActiveTab(DBOT_TABS.BOT_BUILDER);
    ...
    it('render TourStartDialog component with show_mobile_tour_dialog as false when clicking skip in mobile', async () => {
        mock_store.ui.is_desktop = false;
        mock_DBot_store.dashboard.setTourDialogVisibility(true);
        mock_DBot_store.dashboard.setActiveTab(DBOT_TABS.BOT_BUILDER);
