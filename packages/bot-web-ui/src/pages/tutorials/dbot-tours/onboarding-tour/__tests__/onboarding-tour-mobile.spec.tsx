...
describe('Onboarding Tour Mobile', () => {
    ...
    it('should render OnboardingTourMobile steps when clicking start', async () => {
        render(<OnboardingTourMobile />, {
            wrapper,
        });
    ...
    it('should render OnboardingTourMobile steps with previous button from second step', async () => {
        render(<OnboardingTourMobile />, {
            wrapper,
        });
        ...
        await userEvent.click(previous_button);
        expect(screen.getByRole('button', { name: 'Next' })).toBeInTheDocument();
    });

    it('should close OnboardingTourMobile when clicking on skip', async () => {
        render(<OnboardingTourMobile />, {
            wrapper,
        });

        const skip_button = screen.getByRole('button', { name: 'Skip' });
        await userEvent.click(skip_button);
