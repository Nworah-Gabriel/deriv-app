...
describe('BotBuilder Tour Mobile', () => {
    ...
    it('should render BotBuilderTourMobile when active tour is set to bot builder and tour dialog is false', async () => {
    ...
    it('should render BotBuilderTourMobile steps with Next and Previous buttons', async () => {
        render(<BotBuilderTourMobile />, {
            wrapper,
        });
