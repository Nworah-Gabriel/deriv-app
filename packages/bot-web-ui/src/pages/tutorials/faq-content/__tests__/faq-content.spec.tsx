...
const what_is_deriv_bot = 'What is AssetRadar Bot?';
...
describe('<FAQContent />', () => {
    ...
    it('should show content after clicking on accordion', async () => {
        render(<FAQContent faq_list={faq_content} />, { wrapper });
    ...
    it('should call handleAccordionOpen and accordion item should open on desktop', async () => {
        mock_store.ui.is_desktop = true;
        render(<FAQContent faq_list={faq_content} />, { wrapper });
    ...
    it('should call handleAccordionOpen and accordion item should open on mobile', async () => {
        mock_store.ui.is_desktop = false;
        render(<FAQContent faq_list={faq_content} />, { wrapper });
    ...
    it('should call handleAccordionOpen and accordion item should close', async () => {
        render(<FAQContent faq_list={faq_content} />, { wrapper });
    ...
    it('should trigger the keyDown event upon clicking "Enter"', async () => {
        ...
        const accordion = screen.getByTestId('dt_accordion_test');
        await userEvent.type(accordion, '{enter}');
        expect(screen.getByText(deriv_bot_content)).toBeInTheDocument();
    });
    it('should not trigger the keyDown event upon clicking "esc"', async () => {
        ...
        const accordion = screen.getByTestId('dt_accordion_test');
        await userEvent.type(accordion, '{esc}');
        expect(screen.getByText(what_is_deriv_bot)).toBeInTheDocument();
    });
