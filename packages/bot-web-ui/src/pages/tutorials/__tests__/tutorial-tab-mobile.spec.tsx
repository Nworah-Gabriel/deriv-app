...
const userGuideContent = [
    {
        ...
        type: 'Tour',
        subtype: 'OnBoard',
        content: 'Get started on AssetRadar Bot',
...
const guideContent = [
    {
        id: 1,
        type: 'DBotVideo',
        content: 'An introduction to AssetRadar Bot',
...
const faqContent = [
    {
        title: 'What is AssetRadar Bot?',
        description: [
            {
                type: 'text',
                content: 'AssetRadar Bot is a web-based strategy builder for trading digital options',
            },
        ],
    },
];
...
const qsContent = [
    {
        ...
        description: [
            {
                type: 'text',
                content: 'Exploring the Martingale strategy in AssetRadar Bot',
            },
        ],
    },
];
...
describe('<TutorialsTabDesktop />', () => {
    ...
    it('should toggle the search bar visibility when the arrow icon is clicked', async () => {
    ...
    it('should update the search input value and call onSearch', async () => {
    ...
    it('should clear Search on input when clicked on close', async () => {
        const inputElement = screen.getByTestId('id-test-input-search');
        const inputValue = 'Test search query';
    ...
    it('should make the search visible on click of onHandleChangeMobile()', async () => {
        const search_icon = screen.getByTestId('search-icon');

        await userEvent.click(search_icon);
