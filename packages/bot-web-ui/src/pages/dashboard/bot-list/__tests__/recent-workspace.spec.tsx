...
describe('<RecentWorkspace />', () => {
    ...
    it('should open the strategy on click of open icon', async () => {
    ...
    it('should open the strategy on click of open icon on mobile', async () => {
