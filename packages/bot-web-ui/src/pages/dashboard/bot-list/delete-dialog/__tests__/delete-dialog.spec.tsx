...
describe('<DeleteDialog />', () => {
    ...
    it('should close the dialog on click of "No" button', async () => {
        mock_DBot_store?.load_modal.onToggleDeleteDialog(true);
        render(<DeleteDialog />, {
            wrapper,
        });
        ...
        await userEvent.click(el_no_button);
        expect(mock_DBot_store?.load_modal.is_delete_modal_open).toBeFalsy();
    });

    it('should delete the strategy on click of "Yes, Delete" button', async () => {
        mock_DBot_store?.load_modal.onToggleDeleteDialog(true);
        render(<DeleteDialog />, {
            wrapper,
        });
        ...
        await userEvent.click(el_yes_button);
        expect(mock_DBot_store?.load_modal.is_delete_modal_open).toBeFalsy();
    });
