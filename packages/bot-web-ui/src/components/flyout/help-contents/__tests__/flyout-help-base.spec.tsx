...
describe('<HelpBase />', () => {
    ...
    it('should render Image type content', async () => {
        if (mock_DBot_store) {
            mock_DBot_store.flyout_help.help_string = mock_help_string;
    ...
    it('should render onSequenceClick to be called on the next button', async () => {
    ...
    it('should render onSequenceClick to be called on the previous button', async () => {
        const mockOnSequenceClick = jest.fn();
        if (mock_DBot_store) {
            mock_DBot_store.flyout_help.help_string = mock_help_string;
            mock_DBot_store.flyout_help.block_type = 'trade_definition';
