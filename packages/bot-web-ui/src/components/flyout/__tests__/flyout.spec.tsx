...
describe('Flyout', () => {
    ...
    it('should show help content if info icon is clicked and is_search_flyout is true', async () => {
        const element = document.createElement('block');
        element.setAttribute('type', 'variables_set');
    ...
    it('should show help content if info icon is clicked and is_search_flyout is false', async () => {
        const element = document.createElement('block');
        element.setAttribute('type', 'variables_set');
    ...
    it('should add block to the workspace if add button is clicked', async () => {
        const name = 'Add';
        const element = document.createElement('button');
        element.setAttribute('text', name);
        element.setAttribute('placeholder', name);
    ...
    it('should not add block to the workspace if add button is clicked and getButtonCallback is returning null', async () => {
        const name = 'Add';
        const element = document.createElement('button');
        element.setAttribute('text', name);
        element.setAttribute('placeholder', name);
