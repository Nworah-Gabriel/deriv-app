...
describe('messageWithButtonMockProps', () => {
    ...
    it('should call function of the button on click of the button', async () => {
...
describe('arrayAsMessage', () => {
    ...
    it('should handle click on SVG element and show expected content of ExpansionPanel', async () => {
