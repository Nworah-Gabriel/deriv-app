...
describe('<Download />', () => {
    ...
    it('should render the No transaction or activity yet message on transaction tab', async () => {
    ...
    it('should render the Download is unavailable while your bot is running message', async () => {
        render(<Download tab='transactions' />, {
            wrapper,
        });
    ...
    it('should render the Download is unavailable if there is transactions but bot is running', async () => {
        mock_DBot_store?.run_panel?.setIsRunning(true);
    ...
    it('should render the Download your journal message', async () => {
    ...
    it('should render the No transaction or activity yet message on journal tab', async () => {
