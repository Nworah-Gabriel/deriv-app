...
describe('Transaction', () => {
    ...
    it('should render the Transaction component and trigger onClick', async () => {
        render(
            <Transaction
        ...
        await userEvent.click(transaction_item);
    ...
    it('should render the Transaction component with high low barriers and exit time', async () => {
