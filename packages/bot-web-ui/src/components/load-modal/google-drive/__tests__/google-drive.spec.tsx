...
describe('<GoogleDrive />', () => {
    ...
    it('should have ability to close dialog modal and invoke google drive when is_authorised = true', async () => {
        mock_DBot_store?.google_drive?.setIsAuthorized(true);
        render(<GoogleDrive />, { wrapper });
    ...
    it('should disconnect to Google Drive', async () => {
        mock_DBot_store?.google_drive?.setIsAuthorized(true);
        render(<GoogleDrive />, { wrapper });
        const el_disconnect = screen.getByText(/Disconnect/);
        await userEvent.click(el_disconnect);
    ...
    it('should connect to Google Drive', async () => {
        ...
        await userEvent.click(el_signin);
        await waitFor(() => {
