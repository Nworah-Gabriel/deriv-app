...
describe('ConfirmPhoneNumber', () => {
    ...
    it('should trigger mockSend when send button is clicked', async () => {
    ...
    it('should trigger setShouldShowDidntGetTheCodeModal when Didn`t get the code is clicked', async () => {
        renderComponent(false, false);
        const resend_button_after = screen.getByRole('button', { name: "Didn't get the code?" });
        await userEvent.click(resend_button_after);
