...
describe('PasskeysStatusLayout', () => {
    ...
    it('renders PasskeysStatusLayout component correctly', async () => {
        render(
        ...
        await userEvent.click(screen.getByRole('button', { name: mock_primary_button_text }));
        expect(mockOnPrimaryButtonClick).toHaveBeenCalled();
        await userEvent.click(screen.getByRole('button', { name: mock_secondary_button_text }));
