...
describe('LeaveConfirm', () => {
    ...
    it('should sehow modal when value is dirty and trigger unblock function', async () => {
        ...
        await userEvent.click(el_leave_settings_btn);
    ...
    it('should set values as dirty when the user leaves modal', async () => {
        get_transition_blocker_states({ pathname: '/' });
    ...
    it('should change pathname when user leaves form', async () => {
        get_transition_blocker_states({ pathname: '/' });
    ...
    it('should not change pathname when user leaves form', async () => {
