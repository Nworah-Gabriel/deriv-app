...
describe('SetupRealAccountOrGoToDemoModalContent', () => {
    ...
    it('User click "setup real account" button when is_cr_demo = true', async () => {
        ...
        await userEvent.click(setup_btn);
    ...
    it('User click "setup real account" button when is_eu_demo = true', async () => {
    ...
    it('User click "take me to demo" button', async () => {
        const { container } = render(<SetupRealAccountOrGoToDemoModalContent />, {
            wrapper: wrapper(),
        });
        ...
        await userEvent.click(demo_btn);
