...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@deriv-com/analytics"), require("@deriv/components"), require("@deriv/shared"), require("@deriv/translations"), require("mobx"), require("mobx-react-lite"), require("react"), require("react-router"), require("react-router-dom"));
	else if(typeof define === 'function' && define.amd)
		define(["@deriv-com/analytics", "@deriv/components", "@deriv/shared", "@deriv/translations", "mobx", "mobx-react-lite", "react", "react-router", "react-router-dom"], factory);
	else if(typeof exports === 'object')
		exports["@deriv/reports"] = factory(require("@deriv-com/analytics"), require("@deriv/components"), require("@deriv/shared"), require("@deriv/translations"), require("mobx"), require("mobx-react-lite"), require("react"), require("react-router"), require("react-router-dom"));
	else
		root["@deriv/reports"] = factory(root["@deriv-com/analytics"], root["@deriv/components"], root["@deriv/shared"], root["@deriv/translations"], root["mobx"], root["mobx-react-lite"], root["react"], root["react-router"], root["react-router-dom"]);
})(self, (__WEBPACK_EXTERNAL_MODULE__deriv_com_analytics__, __WEBPACK_EXTERNAL_MODULE__deriv_components__, __WEBPACK_EXTERNAL_MODULE__deriv_shared__, __WEBPACK_EXTERNAL_MODULE__deriv_translations__, __WEBPACK_EXTERNAL_MODULE_mobx__, __WEBPACK_EXTERNAL_MODULE_mobx_react_lite__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE_react_router__, __WEBPACK_EXTERNAL_MODULE_react_router_dom__) => {
...
/******/ 			return "reports/js/reports." + chunkId + "." + {"404":"98c995472a305e5900c8","vendors-node_modules_lodash_debounce_index_js-node_modules_mobx-persist-store_lib_esm5_index_-41aa7c":"7c128e3ae7b08a9e10b7","reports-app":"096b2715999ca977da76","trade-modals":"ce7110d28c60d146030b","vendors-node_modules_react-content-loader_dist_react-content-loader_es_js-node_modules_classn-e603fb":"041fb19dd6c7131e5610","reports-routes":"b2473eb823fa1e179f16","vendors-node_modules_moment_moment_js":"9a7db509770a541c7837","two-month-picker":"106a4745f1c7059b15b0"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 			// return url for filenames based on template
/******/ 			return "reports/css/reports." + chunkId + "." + {"reports-app":"c6e5cbfdfbcc03076620","reports-routes":"cd6da124f7e1a2bfa9d0"}[chunkId] + ".css";
/******/ 		};
/******/ 	})();
/******/ 	
